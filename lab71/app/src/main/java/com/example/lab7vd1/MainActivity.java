...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String b = intent.getExtras().getString("du lieu","b");
        tx3.setText("Song.mp3");
        mediaPlayer = MediaPlayer.create(this, R.raw.chita);
        seekbar = (SeekBar) findViewById(R.id.seekBar);
        seekbar.setClickable(false);
        b2.setEnabled(false);
                if(b == ""){
                    Toast.makeText
                            (MainActivity.this,"Tên bài hát bạn nhập không có trong này ",Toast.LENGTH_LONG).show();
                }else{
