...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //load data
        queList.add(new QuestionClass("Đây là hình nộm Que 1", "ans 1", "ans 2",
                "ans 3", "ans 4", "ans 1"));
        queList.add(new QuestionClass("Đây là hình nộm Que 2", "ans 1", "ans 2",
                "ans 3", "ans 4", "ans 2"));
        queList.add(new QuestionClass("Đây là hình nộm Que 3", "ans 1", "ans 2",
                "ans 3", "ans 4", "ans 3"));
        //init conter
        conter = 0;
        ...
        btOpt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btOpt1.getText().equals(q.getRightOpt())) {
                    Toast.makeText(MainActivity.this, "Câu trả lời chính xác", Toast.LENGTH_SHORT).show();
                    ...
                    if (conter < (queList.size() - 1)) {
                        ...
                        Toast.makeText(MainActivity.this, "Tất cả Que đã hoàn thành!", Toast.LENGTH_SHORT).show();
                    }


                } else {
                    Toast.makeText(MainActivity.this, "\n" +
                            "Câu trả lời sai", Toast.LENGTH_SHORT).show();
                }
        ...
        btOpt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btOpt3.getText().equals(q.getRightOpt())) {
                    ...
                    Toast.makeText(MainActivity.this, "Câu trả lời sai ", Toast.LENGTH_SHORT).show();
                }
